...
bilinear_wts_2  = get_upsampling_weight(in_channels=21, out_channels=21, kernel_size=16)
...
class FCN16s(object):
    ...
    def build_train_graph(self, l_rate_decay_step, re_use=False):
        ...
        # Upsample
        with tf.variable_scope('upscore_16'):
            upscore = slim.conv2d_transpose(fuse_pool4, opt.num_classes, [32, 32],
                                  stride=16, activation_fn=None, padding='SAME',
